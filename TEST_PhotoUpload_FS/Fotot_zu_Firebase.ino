...
const char* ssid = "WLAN-Name";                               //anpassen
const char* password = "Passwort";                            //anpassen

#define API_KEY "..."                                         //anpassen

// ENter Authorized Email and Password
#define USER_EMAIL "Mail"                                     //anpassen
#define USER_PASSWORD "Passwort"                              //anpassen

// Enter Firebase storage bucket ID
#define STORAGE_BUCKET_ID "..."                               //anpassen
